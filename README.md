...
## Data Pipeline
The new dataset collection and conversion work lives in [data_pipeline](./data_pipeline/). Start with [V1_SPEC.md](./data_pipeline/V1_SPEC.md) for the current implementation contract and [AGENTS.md](./data_pipeline/AGENTS.md) for the working notes on scope, environment, and build order.
